...
///TODO
    ...
    h_r_array[0] = n - truncat_number_test + 4;
...
///计算中间变量 第二部分
	...
	int comp_rat_number = truncat_number*n;
...
///获得截断索引 truncat_number 也就是h_r_array
///TODO
    h_r_array[2] = n - truncat_number_test + 1;
    ...
    assert(cudaSuccess == cudaStat3);
    assert(cudaSuccess == cudaStat2);
    comp_rat_number = comp_rat_number + n*truncat_number + m*truncat_number;
